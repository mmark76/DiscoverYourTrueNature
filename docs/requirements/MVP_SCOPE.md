...
Create the smallest usable version that allows the owner to test the core experience before adding OpenAI API usage, payments, accounts, analytics, or app-store distribution.
