...
- [ADR-0002: Adopt the Ranked Sixteen-Personality Animal Model (superseded)](ADR-0002-ranked-personality-animal-model.md)
- [ADR-0003: Adopt the Thirty-Question Binary Animal Model](ADR-0003-binary-thirty-question-animal-model.md)
