...
> = {
  forest: {
    light: {
      ...
      footerBackground: '#E8EEE9', footerText: '#26342E', footerMuted: '#596760', heroMuted: '#E2EBE6',
      heroDecoration: '#7F9D91', heroDecorationStrong: '#41695A',
    },
    dark: {
      background: '#0F1713', backgroundMuted: '#15211B', surface: '#18241E', surfaceMuted: '#213128',
      text: '#F1F5F2', mutedText: '#A8B8B0', primary: '#86C9AA', primaryPressed: '#A0D8BE',
      onPrimary: '#102219', accent: '#D08A5B', accentPressed: '#E0A078', onAccent: '#24140B',
      accentMuted: '#493426', border: '#354A40', borderStrong: '#5D7167', focus: '#E0A078',
      disabled: '#2A362F', disabledText: '#91A198', success: '#86C9AA', successSurface: '#213B30',
      warning: '#E0A078', warningSurface: '#493426', progressTrack: '#2A3B32', selection: '#284A3B',
      footerBackground: '#0F1713', footerText: '#F1F5F2', footerMuted: '#A8B8B0', heroMuted: '#26483B',
      heroDecoration: '#4E7967', heroDecorationStrong: '#B8DDCB',
    },
  },
  ocean: {
    light: {
